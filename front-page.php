...
<?php endif; ?>
    ...
    ?>
                <a href="<?php echo $news_link; ?>" class="btn btn-default">
                    最新情報の一覧<i class="fas fa-angle-right"></i>
                </a>
            </p>
    ...
    <section class="sec bg-gray">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="<?php echo get_permalink(26) ?>" class="bnr" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/home/bnr_about@2x.jpg')">
                        <div class="bnr_inner">
                ...
                <div class="col-md-6">
                    <a href="<?php echo get_permalink(36) ?>" class="bnr" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/home/bnr_access@2x.jpg')">
                        <div class="bnr_inner">
